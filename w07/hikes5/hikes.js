import HikeComment from './comment.js';
import {getAllComments, filterCommentsByName, addCommentToLocalStorage, showCommentsList} from './commentHandler.js';
...
function renderHikeList(parent, hikes) {
  hikes.forEach(hike => {
    parent.appendChild(renderOneHikeLight(hike, hikes.indexOf(hike)));
     // Get the button
    const newCommentButton = document.getElementById(`${hikes.indexOf(hike)}-button`);
    // Get comment input div
    const commentBlock = document.getElementById(`${hikes.indexOf(hike)}-comment-input-div`);
    // Get the text area
    ...
    submitButton.addEventListener("click", () => {
      // Take the value of the text area
...
function renderOneHikeLight(hike, indexOfHike) {
...
<div>
        ...
        <div>
          <button id="${indexOfHike}-button">New Comment</button>
